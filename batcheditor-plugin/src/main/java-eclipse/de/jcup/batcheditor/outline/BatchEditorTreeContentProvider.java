...
public class BatchEditorTreeContentProvider implements ITreeContentProvider {
	...
	private static final String BATCH_SCRIPT_CONTAINS_ERRORS = "Batch script contains errors.";
	private static final String BATCH_SCRIPT_DOES_NOT_CONTAIN_ANY_LABELS = "Batch script does not contain any labels";
	private static final Object[] RESULT_WHEN_EMPTY = new Object[] { BATCH_SCRIPT_DOES_NOT_CONTAIN_ANY_LABELS };
	private Object[] items;
	private Object monitor = new Object();

	BatchEditorTreeContentProvider() {
	...
	public Object[] getElements(Object inputElement) {
		synchronized (monitor) {
			if (inputElement!=null && !(inputElement instanceof BatchScriptModel)) {
	...
	public void rebuildTree(BatchScriptModel model) {
		synchronized (monitor) {
			if (model == null) {
				items = null;
				return;
