...
public class BatchLabelHyperlink implements IHyperlink {

	private IRegion region;
	private BatchLabel function;
	private BatchEditor editor;
	

	public BatchLabelHyperlink(IRegion region, BatchLabel function, BatchEditor editor) {
