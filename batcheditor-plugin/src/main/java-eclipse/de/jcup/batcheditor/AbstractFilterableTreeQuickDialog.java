...
import de.jcup.batcheditor.AdaptedFromEGradle;
import de.jcup.batcheditor.FilterPatternMatcher;
import de.jcup.batcheditor.outline.FallbackOutlineContentProvider;
...
public abstract class AbstractFilterableTreeQuickDialog<T> extends AbstractQuickDialog implements IDoubleClickListener {
	...
	private class FilterKeyListener extends KeyAdapter {
		...
		public void keyReleased(KeyEvent e) {
			...
			UIJob job = new UIJob("Rebuild batch editor quick outline") {
