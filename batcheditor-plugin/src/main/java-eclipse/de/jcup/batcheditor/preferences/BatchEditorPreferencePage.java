 ...
 *
 */
public class BatchEditorPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	private BooleanFieldEditor codeAssistWithBatchKeywords;
	private BooleanFieldEditor codeAssistWithSimpleWords;

	public BatchEditorPreferencePage() {
		super(GRID);
	...
	private void setBoolean(BatchEditorPreferenceConstants id, boolean value) {
		getPreferences().setBooleanPreference(id, value);
	}

	private boolean getBoolean(BatchEditorPreferenceConstants id) {
		return getPreferences().getBooleanPreference(id);
	}

	private boolean getDefaultBoolean(BatchEditorPreferenceConstants id) {
