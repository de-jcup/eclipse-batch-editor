...
import de.jcup.batcheditor.ColorManager;
import de.jcup.batcheditor.EclipseUtil;
import de.jcup.batcheditor.outline.Item;
import de.jcup.batcheditor.outline.ItemType;
...
public class BatchEditorOutlineLabelProvider extends BaseLabelProvider implements IStyledLabelProvider, IColorProvider {
	...
	private Styler outlineItemTypeStyler = new Styler() {
		...
		public void applyStyles(TextStyle textStyle) {
			textStyle.foreground = getColorManager().getColor(BatchEditorColorConstants.OUTLINE_ITEM__TYPE);
		}
	};
	...
	private Image getOutlineImage(String name) {
		return EclipseUtil.getImage("/icons/outline/" + name, BatchEditorActivator.PLUGIN_ID);
	}
